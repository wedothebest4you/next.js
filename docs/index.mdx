...
Although our docs are designed to be beginner-friendly, we need to establish a baseline of the basic understanding of React library so that the docs can stay focused on Next.js functionality. We'll make sure to provide links to the relevant documentation which may be a prerequisite to continue your learning.

You can check out our [Next.js Foundations Course](/learn/foundations/about-nextjs), which starts with the reasoning "why to use a framework in general and Next.js in particular". It then moves on to demo the "evolution of application development using vanilla JavaScript to the React library and then to the React framework Next.js itself. It also encourages you to build your first application in Next.js by providing the essential information through step-by-step guidance.
